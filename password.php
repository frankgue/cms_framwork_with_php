<?php 
    ...
    if (isset($_POST['forget_password'])) {
        if (empty($_POST['email']) || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) ) {
            ...
            $requete = $bdd->prepare("SELECT * FROM utilisateurs WHERE email_utilisateur=:email");
            ...
            if ($nombre == 0) {
                $message = "L'adresse email saisie ne correspond a aucun membre!";
            } else {
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Voulez-vous créer un nouveau compte? S'enregistrer!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
