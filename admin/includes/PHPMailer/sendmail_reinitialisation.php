...
$mail->Body = 'Afin de reinitialiser votre mot de passe , merci de cliquer sur le lien suivant:<a href="localhost/webcms/admin/new_password.php?token='.$token.'&email='.$_POST['email'].'">Réinitialiser mot de passe</a>';
