...
$mail->Body = 'Afin de valider votre adresse Email, merci de cliquer sur le lien suivant:<a href="localhost/webcms/admin/verification.php?token='.$token.'&email='.$_POST['email'].'">Confirmation email</a>';
